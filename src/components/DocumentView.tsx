    ...
    <div className="flex-1 flex flex-col min-w-0">
      ...
      >
        <div className="max-w-3xl mx-auto">
          <div className="bg-white dark:bg-maple-800 border border-maple-200 dark:border-maple-800 rounded-xl shadow-sm p-6">
            <div
              id="doc-content"
              ref={docRef}
            ...
            <div className="flex flex-col gap-1.5">
              {canMerge && (
                <button
                  ...
                  className="w-full text-[10px] px-3 py-1.5 bg-maple-800 dark:bg-maple-600 text-white rounded-lg hover:bg-maple-700 dark:hover:bg-maple-500 text-left"
                >
              ...
              <button
                ...
                className={`w-full text-[10px] px-3 py-1.5 rounded-lg text-left ${
                  canMerge 
              ...
              <button
                ...
                className="w-full text-[10px] px-3 py-1.5 bg-maple-100 dark:bg-maple-700 text-maple-700 dark:text-maple-200 rounded-lg hover:bg-maple-200 dark:hover:bg-maple-600 text-left"
              >
      ...
      {spanEditor && note && (
        ...
        >
          ...
          {/* Preview */}
	          <div className="text-[11px] bg-maple-50 dark:bg-maple-700 rounded-lg p-2 mb-3 font-mono break-words max-h-20 overflow-y-auto">
